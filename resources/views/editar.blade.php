    ...
    <div class="card text-left mb-5 border">
        ...
        <div class="card-header text-center" style="color: black">
          Querido diario...
            ...
            <div class="card-body">
                <form class="m-4" action="{{route('recuerdo.update', $consultaID->idRecuerdo)}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="txtTexto" id="" cols="30" rows="4">{{$consultaID->recuerdo}}</textarea>
                    <p class="fst-italic" style="color: crimson">
            ...
            <div class="card-footer">
                    ...
                    <a href="{{route('recuerdo.store')}}" class="btn btn-success">Regresar</a>

                    <button type="submit" class="btn btn-dark m-1">Actualizar datos</button>
